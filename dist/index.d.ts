export type { EmbeddingConfig, IndexState, IndexedFileState, KnowledgeChunk, KnowledgeConfig, Provenance, QdrantConfig, SearchHit, SourceDefinition, SourceType, SourcesManifest, } from "./types.js";
...
export { indexKnowledge, type IndexMode, type IndexOptions, type IndexResult, } from "./index-builder.js";
export { INDEX_STATE_FILE, indexStatePath, loadIndexState, saveIndexState, diffCorpus, type CorpusDiff, } from "./index-state.js";
