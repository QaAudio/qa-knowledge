...
#### Hierarchy ([View Summary](../hierarchy.md#MidiClip))
...
-   get notes(): [NoteDescription](../types/NoteDescription.md)\[\]
    
    #### Returns [NoteDescription](../types/NoteDescription.md)\[\]
    
-   set notes(notes: [NoteDescription](../types/NoteDescription.md)\[\]): void
    
    #### Parameters
    
    -   notes: [NoteDescription](../types/NoteDescription.md)\[\]
