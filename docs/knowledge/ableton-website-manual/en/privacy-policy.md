...
You can deactivate tracking by Snowplow at any time in the “[cookie settings section](https://www.ableton.com/en/cookie-settings/)“.

(i) The purpose of data processing is to analyze individual user behavior. 
...
*   Data generated for web analysis and assigned to your device: This includes the domain ID. Such domain ID is a feature in Snowplow that lets us connect together a given user’s data collected from multiple devices and multiple browsers. 
...
(viii) If you have not given your consent for individual user tracking or if you have revoked it (e.g. by deactivating the Snowplow cookie), Ableton may perform anonymous usage data analysis on the basis of the session ID by means of the software Snowplow. Please find further information [here](https://docs.snowplow.io/docs/sources/trackers/web-trackers/anonymous-tracking/). Ableton will anonymize the connection between the session ID and the website visitor before processing the usage data further, so that no personal identifiable data will be analyzed. The legal basis for the anonymization is the legitimate interest, namely improving the website content (Article 6 para. (1) (f) GDPR).

#### **c) Web Extend (Emarsys)**

If you have given your consent, we use the web analysis tool Web Extend from the provider Emarsys Interactive Services GmbH on our website. With the help of Web Extend, we can examine the user behavior of visitors to our website in pseudonymized and anonymized form and, for example, evaluate purchases made as a result of email campaigns. Further, and also subject to your respective consent, we can link the generated data with the third-party platforms of Meta, TikTok and Google. (Please see below in this section.)
...
You can disable GA4 tracking anytime via our “[cookie settings section](https://www.ableton.com/en/cookie-settings/)“ or the Google Analytics Opt-Out Browser Add-on.
...
You can revoke consent anytime via “[cookie settings section](https://www.ableton.com/en/cookie-settings/)“.
...
If you have granted consent, we implement the TikTok Pixel from TikTok Technology Limited to measure ad effectiveness and create targeted audiences. 
...
#### **g****) Umbraco Engage (on-premise version)**

If you have given your consent, we use the analysis and customer engagement platform Umbraco Engage  on our website. With the help of Umbraco Engage, we can analyze user interactions on our website in pseudonymized and anonymized form and, for example, evaluate how users respond to content or campaigns displayed via email or on-site. We only process data generated by or in connection with Umbraco Engage on (virtual) servers operated by us (on-premise).

You can deactivate data processing by Umbraco Engage at any time in the "[cookie settings section](https://www.ableton.com/en/cookie-settings/)".

(i) The purpose of data processing is to analyze user behavior, measure the effectiveness of our email and on-site campaigns, and optimize our website and marketing communication to provide users with relevant content (e.g. based on browsing behavior or previous interactions).

(ii) The processed data are:

Umbraco Engage HTTP data:

This includes protocol data automatically transmitted when using the website via the Hypertext Transfer Protocol (Secure) (HTTP(S)): IP address, type and version of the Internet browser, operating system used, the page visited, the page previously visited (referrer URL), date and time of the visit.

Umbraco Engage identifiers:

These are pseudonymized identifiers, such as unique user IDs or hashed email addresses, insofar as users are logged in or identifiable through consent-based tracking.

Umbraco Engage interaction data:

Information generated by Umbraco Engage about user activities, such as page views, clicks, form interactions, campaign responses, and session data from the preceding 180 days.

(iii) The legal basis for the processing is your consent (Article 6 para. (1) (a) GDPR).

(iv) The data is automatically transmitted by the user's browser.

(vi) Session data are deleted after the end of the session. The remaining analytical data will be deleted after one year.

(vii) The provision of data is not required by law or contract and is not necessary for the conclusion of a contract. You are not obliged to provide the data. Without this data, we cannot carry out web analysis or campaign performance measurement using Umbraco Engage.

(viii) If you have not given your consent for individual user tracking or if you have revoked it (e.g. by deactivating the Umbraco Engage cookie), Ableton may perform anonymous usage data analysis on the basis of the session ID by means of the software Umbraco Engage. Ableton will anonymize the connection between the session ID and the website visitor before processing the usage data further, so that no personal identifiable data will be analyzed. The legal basis for the anonymization is the legitimate interest, namely improving the website content (Article 6 para. (1) (f) GDPR).

#### **h) Zendesk (on Ableton Help Website)**
...
(v) We use service providers as processors within the framework of a data processing agreement for the provision of services, such as service providers enabling installment payments or providing product repairs, as well as other services providers for the provision, maintenance and servicing of IT systems. Banks and payment providers may be recipients of data for the processing of payments and credit worthiness checks. In individual cases, data may be transferred to debt collection service providers, lawyers and courts.
...
(i) The purpose for data processing on our social media sites is providing you with interesting content and to interact with you on social media platforms. Depending on the social media service usage data may also be analyzed to improve our social media presence. Artificial intelligence may be used for this purpose in accordance with applicable law.

(ii) The data processed are content and usage data on such social media pages.

(iii) Information and data displayed or shared on Ableton social media sites may be accessible to the applicable provider of the social media platform (or other service providers used in connection with respective platform), its users and Ableton (or engaged service providers).
...
**TikTok:**  
We maintain a presence on TikTok. Data processing on this platform is independently managed by TikTok Technology Limited (10 Earlsfort Terrace, Dublin, Ireland), which utilizes global service providers including ByteDance Ltd. (Singapore) and TikTok Pte. Ltd. (Singapore). We lack detailed insight into TikTok’s processing activities, including potential data access under Chinese jurisdiction. For comprehensive details, consult TikTok’s Privacy Policy: [https://www.tiktok.com/legal/privacy-policy](https://www.tiktok.com/legal/privacy-policy). The lawful basis for limited data analysis under GDPR Article 6(1)(f) is legitimate interest in content optimization.

**X:**  
We operate a social media page on X (by X Corp, Inc., 1355 Market Street, Suite 900

San Francisco, CA 94103, USA). For users in the EU/EEA the controller to controller data protection addendum between X and Ableton  applies [https://gdpr.x.com/en/controller-to-controller-transfers.html](/en/controller-to-controller-transfers.md). According to the agreement the collection and processing of this data is the sole responsibility of X. X’s Privacy Policy is available under: [https://x.com/en/privacy](https://x.com/en/privacy) As applicable, the legal basis for the processing of data by Ableton is the legitimate interest in the analysis of usage data in order to improve the X Page (Article 6 para. (1) (f) GDPR).
